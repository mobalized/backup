...
function onLogin(player)
	...
	-- You get 2k per level so make up for lost time
    	local amount = 2000 * player:getLevel()

    	while amount >= 10000 do
    		backpack:addItem(2160, 1)
    		amount = amount - 10000
    	end

    	while amount >= 100 do
    		backpack:addItem(2152, 1)
    		amount = amount - 100
    	end

    	while amount >= 1 do
		backpack:addItem(2148, 1)
		amount = amount - 1
	end
